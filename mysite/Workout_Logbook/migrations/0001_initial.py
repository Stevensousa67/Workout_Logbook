# Generated by Django 4.2.2 on 2023-06-06 01:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primary_muscles', multiselectfield.db.fields.MultiSelectField(choices=[('abs', 'abdominals'), ('ham', 'hamstrings'), ('cal', 'calves'), ('sho', 'shoulders'), ('add', 'adductors'), ('glu', 'glutes'), ('qua', 'quadriceps'), ('bic', 'biceps'), ('for', 'forearms'), ('abd', 'abductors'), ('tri', 'triceps'), ('che', 'chest'), ('mbk', 'middle back'), ('lbk', 'lower back'), ('tra', 'traps'), ('lat', 'lats'), ('nec', 'neck')], default='sho', max_length=3, verbose_name='Primary Muscles')),
                ('secondary_muscles', multiselectfield.db.fields.MultiSelectField(choices=[('abs', 'abdominals'), ('ham', 'hamstrings'), ('cal', 'calves'), ('sho', 'shoulders'), ('add', 'adductors'), ('glu', 'glutes'), ('qua', 'quadriceps'), ('bic', 'biceps'), ('for', 'forearms'), ('abd', 'abductors'), ('tri', 'triceps'), ('che', 'chest'), ('mbk', 'middle back'), ('lbk', 'lower back'), ('tra', 'traps'), ('lat', 'lats'), ('nec', 'neck')], default='sho', max_length=3, verbose_name='Secondary Muscles')),
